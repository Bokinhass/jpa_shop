...
<h1 align="center" style="font-weight: bold;">Shop Hibernate 💻</h1>
...
Use the `application.properties.example` as reference to create your configuration file `application.properties` with
